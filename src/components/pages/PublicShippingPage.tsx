import { ArrowLeft, Upload, Truck, Download, Clock, CheckCircle } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto p-4 lg:p-8 py-8">
                <div className="bg-white dark:bg-slate-900/50 backdrop-blur-xl border border-gray-200 dark:border-slate-800 rounded-2xl p-6 lg:p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h1 className="text-3xl text-gray-900 dark:text-white">Shipping & Delivery Policy</h1>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-gray-900 dark:text-white mb-1 font-medium">Purchase Notes</h4>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-gray-900 dark:text-white mb-1 font-medium">Instant Access</h4>
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="flex-shrink-0 w-10 h-10 bg-pink-100 dark:bg-pink-500/20 rounded-full flex items-center justify-center">
                                        <span className="text-pink-600 dark:text-pink-400 font-semibold">3</span>
                                    </div>
                                    <div>
                                        <h4 className="text-gray-900 dark:text-white mb-1 font-medium">Download from "Downloads" Section</h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 rounded-lg p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h4 className="text-gray-900 dark:text-white font-medium">Processing Time</h4>
                                    </div>
                                    <p className="text-sm text-gray-700 dark:text-slate-300">
                                        <span className="text-green-600 dark:text-green-400 font-semibold">Instant</span> - Notes are available immediately after payment confirmation
                                    </p>
                                </div>
                                ...
                                <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 rounded-lg p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <h4 className="text-gray-900 dark:text-white font-medium">Download Speed</h4>
                                    </div>
                                    <p className="text-sm text-gray-700 dark:text-slate-300">
